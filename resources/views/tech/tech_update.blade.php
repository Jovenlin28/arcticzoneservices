...
<div class="row">
    <div class="col-lg-4 col-xl-4">
        <div class="card-box text-center">
            <img src="{{ asset('assets/images/default.png')}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
            ...
            <div class="text-left mt-3">
                ...
                <p class="text-muted mb-2 font-13"><strong>Email Address :</strong> <span class="ml-2 ">marciavalerio@gmail.com</span></p>

                <p class="text-muted mb-1 font-13"><strong>Address :</strong> <span class="ml-2">1720 Dahlia St. Purok 17 Brgy. Commonwealth Quezon City</span></p>
