	...
	<div class="pricing">
		<div class="container">
			...
			<form class="text-center">
				...
				<button id="get-service-fee" 
					type="button" 
					class="btn btn-lg btn-primary">Get Prices</button>
			...
			<div class="pricing-info">
				...
				<div class="text-center">
					...
					@foreach ($service_types as $service_type)
						<div data-service-type-id="{{ $service_type->id }}" 
							class="service-type">
							<h3> {{ $service_type->name }}</h3>
							<div class="row mt-4">
								@foreach ($service_type->service_fees as $service)
									<div class="col-md-4">
										<img width="80" height="80" class="appliance-img"
											src="{{ asset('assets/images/acimages/' . $service->appliance->image) }}">
										<p class="mt-2 ">₱ {{ $service->fee }} .00 <i>per unit</i></p>
									</div>
								@endforeach
							</div>
						</div>
