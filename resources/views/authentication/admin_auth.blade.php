...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                         ...
                         <div class="card" style="box-shadow: 0 4px 4px 0 rgba(0, 0, 0, 0.1), 0 1px 1px 0 rgba(0, 0, 0, 0); border-radius: 1px;">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                 ...
                                 <h5 class="auth-title">ADMINISTRATION - Sign In</h5>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <a href="/admin/dashboard"><button class="btn btn-primary btn-block" type="button"> Log In </button></a>
                                    </div>
                                </form>

                                <div class="row mt-3">
                                    <div class="col-12 text-center">
                                        <p><a href="/admin/forgot_password" class="text-muted ml-1">Forgot your password?</a></p>
                                    </div>
                                </div>  
        ...
        <footer class="footer footer-alt">
            <a href="/">Arctic Zone Thermo Solutions Inc.</a> | Administration Account 
        </footer>
