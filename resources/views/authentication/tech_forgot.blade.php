...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card" style="box-shadow: 0 4px 4px 0 rgba(0, 0, 0, 0.1), 0 1px 1px 0 rgba(0, 0, 0, 0); border-radius: 1px;">
                            ...
                            <div class="card-body p-4">
                                ...
                                <h5 class="auth-title">TECHNICIAN - Forgot Password</h5>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 text-center">
                                        <p class="text-muted">Back to <a href="/tech/auth/login" class="text-muted ml-1"><b class="font-weight-semibold">Log In</b></a></p>
                                    </div> 
                                </div>
                            </div> 
                        </div>
        ...
        <footer class="footer footer-alt">
            Arctic Zone Thermo Solutions Inc. | Technician Account
        </footer>
