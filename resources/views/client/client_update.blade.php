                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="text" name="firstname" value="{{$user->client->firstname}}"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="text" name="lastname" value="{{$user->client->lastname}}"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="email" name="email" value="{{$user->email}}" class="form-control" id="email"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="text" name="contact_number" value="{{$user->client->contact_number}}"
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="password" name="password_confirmation" class="form-control" id="confirm-password"
