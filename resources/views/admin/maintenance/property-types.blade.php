      ...
      <div class="card-body">
        ...
        <table id="basic-datatable" class="table dt-responsive">
          ...
          <tbody>
            ...
            <tr id="{{$property_type->id}}">
              <td>{{$property_type->id}}</td>
              <td>{{$property_type->name}}</td>
              <td>{{$property_type->created_at}}</td>
              <td>
                <button type="button" class="btn btn-success btn-sm" onclick="show_edit_modal({{$property_type}})"><i
                    class="la la-pencil"></i></button>

                <button type="button" class="btn btn-danger btn-sm" onclick="delete_property({{$property_type->id}})"><i
...
<script type="text/javascript">
  function addRow(data) {
    ...
    function show_edit_modal(property_type){
        eliminate_errors('#property_name','#property_name_error');
        document.getElementById('property_form').reset();
        $('#id').val(property_type.id);
        $('#property_name').val(property_type.name);
