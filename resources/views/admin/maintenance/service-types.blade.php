        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="basic-datatable" class="table dt-responsive">
                    ...
                    <tbody>
                        @foreach($service_types as $services)
                        <tr id="{{$services->id}}">
                            <td>{{$services->id}}</td>
                            <td>{{$services->name}}</td>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btn-sm"
                                    onclick="show_edit_modal({{$services->id}})"><i class="la la-pencil"></i></button>

                                <button type="button" class="btn btn-danger btn-sm"
                                    onclick="delete_service({{$services->id}})"><i class="la la-trash"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
