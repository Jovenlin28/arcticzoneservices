          ...
          <tbody>
            ...
            <tr id="{{$bank->id}}">
              ...
              <td>
                ...
                <button type="button" class="btn btn-danger btn-sm" onclick="delete_bank({{$bank->id}})"><i
      ...
      <div class="card-body">
        ...
        <form id="addbank_form">
          ...
          <div class="form-group">
            ...
            <input type="text" name="number" id="number" placeholder="Enter account number" class="form-control"
              required>
