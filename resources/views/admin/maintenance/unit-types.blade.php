        ...
        <table id="basic-datatable" class="table dt-responsive">
          ...
          <tbody>
            ...
            <tr id="{{$unit->id}}">
              ...
              <td>{{$unit->fee}}.00</td>
              <td>
                <button type="button" class="btn btn-success btn-sm" onclick="show_edit_modal({{$unit}})"><i
                    class="la la-pencil"></i></button>

                <button type="button" class="btn btn-danger btn-sm" onclick="delete_units({{$unit->id}})"><i
